...
public class PlantWateringService extends IntentService{
    ...
    public static final String EXTRA_PLANT_ID = "com.example.android.mygarden.extra_plant_id";
    ...
    public static void startActionUpdatePlantsWidgets(Context context) {
        Intent intent = new Intent(context, PlantWateringService.class);
    ...
    private void handleActionUpdatePlantWidgets() {
        ...
        PlantWidgetProvider.updatePlantWidgets(this, appWidgetManager, imgRes, appwidgetIds, canWater, plantId);
    }
    ...
    private void handleActionWaterPlant(long plantId) {
        ...
        startActionUpdatePlantsWidgets(this);
    }
}
